...
$market->addCurrency(new \Cryptocurrency\Task1\Bitcoin(8700));
$market->addCurrency(new \Cryptocurrency\Task1\Ethereum(679));
$market->addCurrency(new \Cryptocurrency\Task1\Dogecoin(0.0046));
